...
> **SSoT role**: Decision-quality / evidence-sufficiency / agent-bias cookbook for novahaku agents.
...
| R37 MCP gateway product | no in-repo gateway; tool availability + human confirm |
