...
# Usage:
#   powershell -File scripts/reverse-skill/case-guard.ps1 -CaseRoot work\my-case
#   powershell -File scripts/reverse-skill/case-guard.ps1 -CaseRoot work\my-case -Force   # compatibility flag; never bypasses scope hard gates
param(
