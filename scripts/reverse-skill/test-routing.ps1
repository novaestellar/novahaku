...
# 用法：
#   powershell -NoProfile -ExecutionPolicy Bypass -File scripts/reverse-skill/test-routing.ps1
#   powershell -File scripts/reverse-skill/test-routing.ps1 -Quick          # 只跑 quick 最小回归集
#   powershell -File scripts/reverse-skill/test-routing.ps1 -Benchmark <path> -LogDir <dir>
