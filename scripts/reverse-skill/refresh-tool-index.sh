...

{
  ...
  echo "- Script: \`scripts/reverse-skill/refresh-tool-index.sh\`"
...
# Parity with scripts/reverse-skill/refresh-tool-index.ps1. Registration is discovered
...
with open(output_json, 'w', encoding='utf-8') as f:
    json.dump({
        ...
        'platform': platform,
        'uname': uname,
        'script': 'scripts/reverse-skill/refresh-tool-index.sh',
        'tools': tools,
