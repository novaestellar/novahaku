...
# Usage:
#   powershell -NoProfile -ExecutionPolicy Bypass -File scripts/reverse-skill/test-p0-friction.ps1
#   powershell -File scripts/reverse-skill/test-p0-friction.ps1 -ScratchDir $env:TEMP\my-scratch
param(
    [string] $ScratchDir = '',
    [string] $PackageRoot = ''
)
