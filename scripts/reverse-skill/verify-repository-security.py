...
PAYLOAD_PATH = "testing/references/web-notes/waf-bypass.md"
PAYLOAD_SHA256 = "ee20666bd4e026c9cae42b6c7b97596490e6f364a0009ce65be1b1990c90e2c0"
...
SCAN_EXCLUDES = {"scripts/reverse-skill/verify-repository-security.py"}
EXPECTED_PATTERN_HITS = {
    ("kali/scripts/lib/tool-discovery.sh", "dev-tcp-port-probe"),
    ("scripts/reverse-skill/lib/ToolDiscovery.ps1", "tcp-client-health-probe"),
}
PATTERNS = {
