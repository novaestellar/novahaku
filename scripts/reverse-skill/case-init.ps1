...
#   powershell -File scripts/reverse-skill/case-init.ps1 -Hint "web pentest" -CaseName my-case `
#     -AuthGranted -TargetUrl "https://app.example/" -NetworkProfile authorized_target_only
# Offline sample ready-to-act example:
#   powershell -File scripts/reverse-skill/case-init.ps1 -Hint "offline apk" -CaseName my-sample `
...
4. Append Evidence: ``scripts/reverse-skill/append-evidence.ps1 -CaseRoot <this dir> ...``
...
Write-Host ("PRIMARY skill: novahaku/{0} ({1})" -f $primary, $primaryId)
