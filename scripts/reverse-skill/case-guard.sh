...
# Usage:
#   bash scripts/reverse-skill/case-guard.sh --case-root work/my-case
#   bash scripts/reverse-skill/case-guard.sh --case-root work/my-case --force  # compatibility flag; never bypasses scope hard gates
set -euo pipefail
