...
#
# Parity target: scripts/reverse-skill/bootstrap-reverse.ps1
...
#
# Usage:
#   bash scripts/reverse-skill/bootstrap-reverse.sh <capability1> [capability2] ... [--start-services] [--skip-refresh] [--mcp-host=none|claude|codex|both]
#   bash scripts/reverse-skill/bootstrap-reverse.sh --list
...
Examples:
  bash scripts/reverse-skill/bootstrap-reverse.sh jadx apktool frida
  bash scripts/reverse-skill/bootstrap-reverse.sh jshookmcp --mcp-host=codex
  bash scripts/reverse-skill/bootstrap-reverse.sh reqable-mcp --mcp-host=claude
  bash scripts/reverse-skill/bootstrap-reverse.sh idapro --start-services --mcp-host=both
  bash scripts/reverse-skill/bootstrap-reverse.sh burpsuite-mcp
