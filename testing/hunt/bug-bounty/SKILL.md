...
> **For the full hunting methodology** — 5-phase non-linear workflow, developer psychology framework, session discipline, tool routing by phase, and Wide/Deep route selection — see **`testing/hunt/bb-methodology/SKILL.md`**.
...
git clone https://github.com/shuvonsec/claude-bug-bounty.git testing/hunt/bug-bounty
ln -s testing/hunt/bug-bounty/SKILL.md testing/hunt/bug-bounty/SKILL.md
