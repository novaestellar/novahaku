...
*(Code - Error: 6. Click on "Show advanced permissions" — screenshot not included in this copy)*
...
*(Code - Error: See the privileges "Administrators" have over winlogon.exe — screenshot not included in this copy)*
