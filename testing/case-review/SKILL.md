...
3. `NEXT`: read `../tool availability`; this skill uses only Python 3 standard library and does not require bootstrap.
...
```bash
python3 testing/case-review/scripts/review_case.py work/<case> --format markdown
```
...
```bash
python3 testing/case-review/scripts/review_case.py work/<case> --format json
```
...
```bash
python3 testing/case-review/scripts/review_case.py work/<case> --verify-hashes --strict
```
...
```bash
python3 testing/case-review/scripts/review_case.py work/<case> --strict --format markdown > work/<case>/report/case-review.md
```
