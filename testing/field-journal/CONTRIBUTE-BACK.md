...
- 不会提交你的 tool availability、scope、findings 等私有文件
- 贡献后其他用户也能复用你的经验
...
git add testing/field-journal/YYYY-MM-DD_*.md
git add testing/field-journal/_index.md
...
- `testing/field-journal/YYYY-MM-DD_*.md`（新的经验条目）
- `testing/field-journal/_index.md`（索引更新）

**黑名单**（绝对不能出现在 PR 中）：
- `tool availability.*`（包含用户本机路径）
