...
powershell -File scripts/reverse-skill/test-routing.ps1
powershell -File scripts/reverse-skill/verify-routing-coherence.ps1
bash scripts/reverse-skill/master-route.sh --hint "case review evidence graph"
```
