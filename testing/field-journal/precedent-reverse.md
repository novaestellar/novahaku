...
| IDA Pro | 9.0 | 见 tool availability reference |
| r2 / rabin2 | latest | `r2` / `rabin2` (PATH) |
| Ghidra | 11.4 | 见 tool availability reference |
| GoReSym | latest | `GoReSym` (PATH) |
| dnSpy | latest | 见 tool availability reference |
| objection | latest | `objection` (PATH) |
| class-dump | latest | 见 tool availability reference |
