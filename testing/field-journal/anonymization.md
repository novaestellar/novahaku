...
已封装为 `scripts/reverse-skill/scan-leaks.ps1`（PowerShell，PS 5.1 / pwsh 兼容），每次提交前跑：
```powershell
powershell -File scripts/reverse-skill/scan-leaks.ps1 -Path testing/field-journal
```
