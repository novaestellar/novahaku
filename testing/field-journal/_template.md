...
## 角色
<!-- lead / cie / cpe / cre / … 见 docs/ops/role-map.md -->
- lead_role: lead
- specialists: []
...
<!-- 字段对齐 testing/case-review/scripts/review_case.py 契约（见下方说明） -->
...
> 每条证据须满足 `testing/case-review/scripts/review_case.py` 的字段契约，否则 `--strict` 校验会 FAIL：
>
...
>
> 自检：`python testing/case-review/scripts/review_case.py <case_root> --verify-hashes --strict`
