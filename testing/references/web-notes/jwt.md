...
*(JWT Vulnerabilities (Json Web Tokens) - Quick Wins: If you are lucky the tool will find some case where the we — screenshot not included in this copy)*
...
*(jku - x5u: Then you can use for example jwt.io to create the new JWT with the created public and private keys  — screenshot not included in this copy)*
...
*(x5u - x5c: This parameter may contain the certificate in base64 — screenshot not included in this copy)*
...
*(x5c - Embedded Public Key (CVE-2018-0114): If the JWT has embedded a public key like in the following scenario — screenshot not included in this copy)*
