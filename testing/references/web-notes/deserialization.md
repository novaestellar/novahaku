...
*(proto and prototype pollution - node-serialize: Inside the file node-serialize/lib/serialize.js you can find t — screenshot not included in this copy)*
...
*(https://www.blackhat.com/docs/us-16/materials/us-16-Kaiser-Pwning-Your-Java-Messaging-With-Deserialization-Vul — screenshot not included in this copy)*<sup>[[25]](#references)</sup>
