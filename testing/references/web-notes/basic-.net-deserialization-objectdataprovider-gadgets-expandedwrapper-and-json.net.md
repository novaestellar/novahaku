...
ObjectDataProvider Gadget - How is this possible: Note that at the end of the code it's calling this.QueryWorke(null). Let's see what does that execute.png>)
